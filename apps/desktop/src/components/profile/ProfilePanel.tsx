...
export function ProfilePanel({ onClose, onOpenSettings }: ProfilePanelProps) {
  ...
  return (
    <div
      ref={panelRef}
      className="fixed left-[68px] top-3 z-50 w-[280px] bg-feiyu-card rounded-xl shadow-xl border border-feiyu-border overflow-hidden animate-fade-in"
    >
      {/* User info */}
      ...
      <div className="py-1">
        <button
          ...
          className="w-full px-4 py-2.5 text-sm text-left text-feiyu-text hover:bg-gray-50 transition-colors"
        >
